...
const STAT_KEYS = [
  { value: '500+', key: 'carsInFleet' },
  { value: '50 000+', key: 'happyClients' },
  { value: '5', key: 'yearsOnMarket' },
  { value: '98%', key: 'clientsRecommend' },
] as const;
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-5xl font-bold mb-4">
            <span className="text-yellow-500">UNICAR</span>
            <span className="text-white ml-3">{t('statistics.title')}</span>
          </h2>
